...
$(document).ready(function () {
	...
	// GM_xmlhttpRequest ( {
	// 	method:		"GET",
	// 	url:		"http://games.espn.go.com/ffl/leaguesetup/sections/scoring",
	// 	data:		"leagueId=" + encodeURIComponent (483414),
	// 	onload: function(d) {
	// 		parse_data(d.responseText);
	// 	}
	// });
	...
	function fetchPositionProjections(position, cb) {
		...
		GM_xmlhttpRequest ( {
			...
			url:		source_site,
			onload: function(res) {
				cb(position, res.responseText.trim());
			}
		});
	}
